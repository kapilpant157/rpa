      ...
      <div className="container">
        <div className="flex flex-col text-center w-full mb-20">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            ...
            This can bee something you could fing helpful. Browse by category.
          </p>
        </div>
        <div className="flex flex-wrap -m-12">
          ...
          <div className="p-12 md:w-1/2 flex flex-col items-start">
            ...
            <p className="leading-relaxed mb-8">
              No Foreign person can investment in Nepal without prior approval
              of the Department of Industry in Nepal. Any one desirous of making
        ...
        <div className="flex flex-col text-center w-full mb-10">
          <a
            className="sm:text-2xl text-2 mt-5 font-medium title-font  text-green-900"
            href="/infozone/Blogs"
          >
            Read More Blogs..
          </a>
