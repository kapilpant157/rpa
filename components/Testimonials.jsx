            ...
            <div className="h-full bg-gray-100 p-8 rounded">
              ...
              <a className="inline-flex items-center">
                ...
                <span className="flex-grow flex flex-col pl-4">
                  <span className="title-font font-medium text-gray-900">Dilli Raj Lekhak</span>
          ...
          <div className="p-4 md:w-1/2 w-full">
            <div className="h-full bg-gray-100 p-8 rounded">
              ...
              <a className="inline-flex items-center">
                ...
                />
                <span className="flex-grow flex flex-col pl-4">
                  <span className="title-font font-medium text-gray-900">Bhuwan</span>
                  <span className="text-gray-500 text-sm">Proprietor</span>
                </span>
              </a>
            </div>
          </div>
